...
En general, queremos que nuestras bases de datos tabulares tengan una estructura *tidy*, como la siguiente figura muestra:

<div class="figure" style="text-align: center">
<img src="00-images/manejo_tidy-4.png" alt="Así es como 'R Para Ciencia de Datos' define una estructura *tidy*" width="60%" />
<p class="caption">(\#fig:unnamed-chunk-2)Así es como 'R Para Ciencia de Datos' define una estructura *tidy*</p>
</div>
